...
== Introduction ==
En este juego vas a recibir artículos de diversas fuentes tratar con diferentes grupos de gente, quienes te mandarán artículos periodísticos, publicaciones de blogs y de redes sociales. Puedes compartir con ellos los artículos que te llegan (¡o no!) y ver cómo reaccionan a lo que les envías. #parrafo
Cada grupo responderá a los artículos de manera diferente. A unos les interesará lo que les envías, mientras que a otros no les gustará o estarán en desacuerdo con lo que diga el artículo. ¿Puedes identificar qué les hace reaccionar así a cada noticia? ¿De dónde salen sus respuestas?#parrafo
