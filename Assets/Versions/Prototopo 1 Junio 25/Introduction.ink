...
Would you like to learn who these groups are?
...
== explain_g2 ==
Your family are your children and grandchildren. Your grandchildren in particular have taught you how to use your phone and messaging, so they are good at technology, and they seem to be up to date with news. 
/* This is group 2
...
This is a piece of fake news - it does not have names of specific people, institutions, it doesn not include sources, and it is written in an incendiary way to get people riled up. This is not a fact-checked piece of news. The goal of this text is to outrage the reader, and to spread out the anger among other people. 

In this story, it is important to check the articles you receive, and check the source and how it is written. It is up to you to resend it to different people - each group will react to the news differently. Some people just want to receive news that confirm how they feel - whether they are fact-checked or not. Some people may realize that the article is really a scam; others may not and fall for it. 
