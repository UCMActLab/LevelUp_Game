...
The body of the text is {article_data (print_article, body)}-> s5_choice
...
+ [Don't send it to anyone] -> s5_results

== s5_g1 ==
    This is the reaction of group 1 to your message.
    The value of group 1 is {group_1}-> s5_choice
    
== s5_g2 ==
    This is the reaction of group 2 to your message. 
    The value of group 2 is {group_2}-> s5_choice

== s5_g3 == 
    This is the reaction of group 3 to your message. 
    The value of group 3 is {group_3}-> s5_choice
