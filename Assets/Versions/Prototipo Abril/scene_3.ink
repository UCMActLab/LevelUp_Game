...
The body of the text is {article_data (print_article, body)}-> s3_choice
...
+ [Don't send it to anyone] -> s3_results

== s3_g1 ==
    This is the reaction of group 1 to your message.
    The value of group 1 is {group_1}-> s3_choice
    
== s3_g2 ==
    This is the reaction of group 2 to your message. 
    {scold2()}
    The value of group 2 is {group_2}-> s3_choice

== s3_g3 == 
    This is the reaction of group 3 to your message. 
    {scold1()}
    The value of group 3 is {group_3}-> s3_choice
